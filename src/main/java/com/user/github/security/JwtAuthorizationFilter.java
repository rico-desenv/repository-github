...
public class JwtAuthorizationFilter extends BasicAuthenticationFilter {
	...
	private UsernamePasswordAuthenticationToken getAuthentication(HttpServletRequest request) {
		...
		if (!"".equals(token) && token != null && token.startsWith(SecurityConstants.TOKEN_PREFIX)) {
			if (JWT_SECRET == null)
			...
			try {
				...
				List<SimpleGrantedAuthority> authorities = ((List<?>) parsedToken.getBody().get("permissions")).stream()
